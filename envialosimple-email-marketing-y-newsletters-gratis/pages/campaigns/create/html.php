...
<div class="wrap es-page">
    <div id="campaignCreate">
        ...
        <h1><?php echo esc_html(__("Crear campaña","envialosimple-email-marketing-y-newsletters-gratis")); ?></h1>
            ...
            <div class="row columnsBlock">
                ...
                <div class="col-md-6 rightBlock">
                    <div  class="emptyContent" v-if="!form.content">
                        ...
                        <p class="mb30"><?php echo esc_html(__("Crea un correo profesional que se adapta a dispositivos móviles utilizando el editor gráfico. También puedes elegir el modo programador del editor para realizar tu contenido.","envialosimple-email-marketing-y-newsletters-gratis")); ?></p>
                        <p class="btnBlock">
                            <span class="btn btn-primary" v-on:click="showModalContent()"><?php echo esc_html(__("Crear contenido","envialosimple-email-marketing-y-newsletters-gratis")); ?></span>
                        </p>
                    </div>
