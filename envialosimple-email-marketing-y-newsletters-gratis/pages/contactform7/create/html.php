...
<div class="wrap es-page" >
    <div id="es-contactform7-list">
        ...
        <div class="row">
            <div class="col-md-6">
                <h1 class=""><?php echo esc_html(__("Vincular formulario de contacto","envialosimple-email-marketing-y-newsletters-gratis")); ?></h1>
                <p><?php echo (__("Tienes configurados algunos formularios Contact Form 7 en tu blog y puedes aprovecharlos para enriquecer tus listas de contactos de EnvíaloSimple. En caso de presentarse un error en la vinculación de los campos personalizados, se enviará un correo electrónico con los valores que intentó registrar el contacto. El correo electrónico del contacto siempre se registrará.","envialosimple-email-marketing-y-newsletters-gratis")); ?></p>
                <p>
                    <?php echo (__("<b>Correo de confirmación de suscripción</b>. Le enviaremos uno a cada contacto que complete este formulario. Este mail asegura que tus campañas sean recibidas por las personas correctas y te protege de suscripciones indeseadas. Te invitamos a leer los beneficios del mismo","envialosimple-email-marketing-y-newsletters-gratis")); ?>
                    <a target="_blank" href="<?php echo esc_html(__("https://faqs.envialosimple.com/contactos-y-listas/formularios","envialosimple-email-marketing-y-newsletters-gratis")); ?>">
                        <?php echo esc_html(__("aquí.","envialosimple-email-marketing-y-newsletters-gratis")); ?>
                    </a>
                    <br/>
                    <?php echo (__("Recuerda que <b>debes contar</b> con el servicio de SMTP de WordPress o con algún plugin especifico para que se realicen los envíos. En <b>EnvíaloSimple</b> disponemos con un plugin que te ayudará a que consigas contactos deseados. Puedes explorar más detalles haciendo clic en ","envialosimple-email-marketing-y-newsletters-gratis")); ?>
                    <a target="_blank" href="<?php echo esc_html(__("https://es-ar.wordpress.org/plugins/envialosimple-transaccional/","envialosimple-email-marketing-y-newsletters-gratis")); ?>">
                    &nbsp;<?php echo esc_html(__("ver.","envialosimple-email-marketing-y-newsletters-gratis")); ?>
                    </a>
                </p>
                <div class="formListsBlock mt20">
                    <div class="form-group mb40">
                        <label><strong><?php echo esc_html(__("Selecciona el formulario del que quieres tomar datos","envialosimple-email-marketing-y-newsletters-gratis")); ?></strong></label>
