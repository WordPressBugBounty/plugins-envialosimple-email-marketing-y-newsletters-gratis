...
<html>
    ...
    <body>
        <div class="offlineValidationMessage">
            <h1 >
                <svg style="width: 30px;display: inline-block;vertical-align: middle;margin-right:20px;height: auto;" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="122.88px" height="122.879px" viewBox="0 0 122.88 122.879" enable-background="new 0 0 122.88 122.879" xml:space="preserve">
                    <g>
                ...
                No pudimos suscribirte a nuestra lista de contactos
            </h1>
            <p >Por favor ingresa al correo que te enviamos e inténtalo de nuevo.</p>
        </div>
    </body>
</html>